          ...
          <div class="list_con">
            ...
            >
              <el-row>
                ...
                <div class="list_con_input">
                  <el-form-item label="（测算）常规直购电价" prop>
                    <direct-purchase-input v-model="ruleForm" />
                  </el-form-item>
                </div>
                <div class="list_con_input">
              ...
              <el-row style="padding: 50px 50px 0 50px;">
                <el-col :span="12">
                  <el-form-item label="选择品种" prop="transactionVariety">
                    <el-select
                      size="small"
                      clearable
                      placeholder="请选择"
                      v-model="ruleForm.transactionVariety"
                    >
                      <el-option
