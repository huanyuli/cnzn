    ...
    <div class="marterial">
      ...
      <div class="ma_content">
        <div class="cont_div">
          ...
          <p>暂无合同</p>
          <div class="cont_btn"><el-button @click="dialogTableVisible = true" type="primary">创建合同</el-button></div>
          <div class="wi_btn"><el-button @click="dialogTable = true" plain>导入合同</el-button></div>
        </div>
      </div>
    </div>
