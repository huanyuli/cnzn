            ...
            >
              ...
              <div class="list_con_input">
                <el-form-item label="企业总用电量" prop="two_3">
                  <el-input type="number" size="medium" placeholder v-model.number="ruleForm.two_3">
              ...
              <div class="list_con_input">
                <el-form-item label="变压器容量" prop="two_4">
                  <el-input type="number" size="medium" placeholder v-model.number="ruleForm.two_4">
          ...
          <div>
            ...
            <div class="list_con">
              ...
              <div class="table three_table list_table">
                <el-form :model="forms['table'+ cols[0].tableId]" :ref="'form' + idx">
                  <el-table class="compile-table" :data="generateRows(cols)" border size="mini">
