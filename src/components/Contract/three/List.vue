    ...
    <div class="marterial">
      ...
      <div class="ma_content">
        ...
        <div v-if="this.no_val == 1" class="content_list">
          <div   v-for='(item,index) in this.list_con.list'  @click="list_daterial(item.id,index)" class="content_list_div">
            <div class="content_list_con">
              <div class="list_img">
                <img v-if="index == 0" src="../../../assets/aImg/random1.png" alt="">
                <img v-if="index == 1" src="../../../assets/aImg/random2.png" alt="">
                <img v-if="index == 2" src="../../../assets/aImg/random3.png" alt="">
                <img v-if="index == 3" src="../../../assets/aImg/random4.png" alt="">
                <img v-if="index == 4" src="../../../assets/aImg/random1.png" alt="">
                <img v-if="index == 5" src="../../../assets/aImg/random2.png" alt="">
                <img v-if="index == 6" src="../../../assets/aImg/random3.png" alt="">
                <img v-if="index == 7" src="../../../assets/aImg/random4.png" alt="">
                <img v-if="index == 8" src="../../../assets/aImg/random1.png" alt="">
                <img v-if="index == 9" src="../../../assets/aImg/random2.png" alt="">
                <img v-if="index == 10" src="../../../assets/aImg/random3.png" alt="">
                <img v-if="index == 11" src="../../../assets/aImg/random4.png" alt="">
              </div>
              <div class="list_right">
                <p ><label>{{item.name}}</label></p>
                <p>合同起止时间：{{get_time_date(item.beginTime)}} - {{get_time_date(item.endTime)}}</p>
                <p>供电方：{{item.provider}}</p>
              </div>
            </div>
          </div>
        </div>
...
<script>
  ...
  export default {
    data() {
      return {
        dataurl:this.HOST + "/apiFile/purchaseContractCreateService",
        file:{
          fileId:"",
          name:""
        },
...
// 映射store数据
    ...
    methods: {
      ...
      list_daterial(id,index){ //查看详情
        this.$router.push({name:'detail',params:{one:id,two:index}});
      },
      find_list(){   //进行筛选
        this.page = 1
        this.formData = "{'page':'"+ this.page +"','limit':'"+ this.limit +"','provider': '"+ this.contract_Type +"','name':'"+ this.cont_name +"','year':'"+ this.time_value +"','limit':10,'page':1}",
        this.list_find(this.formData)
      },
      list_find(data){  //data：参数   type：第一次列表查询
        list_contract.purchaseContractListService(data, res => {  //合同列表
      ...
      submitForm(formName) {  //表单提交验证
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            list_contract.purchaseContractCreateService(this.up_file, res => {  //合同创建
              this.$emit('login-success', res)
            }, (res) => {
              if(res.status == 200){
