<template>
  <div>
    <div class="left_two">
      <div  v-if="show_map(14) == 14" @click='aa' class="left_two_list" :class="{click_list:this.click_index == 1}">
        <div class="list_right">
          <p>富余电基数</p>
        </div>
      </div>
      <div  v-if="show_map(15) == 15" @click='bb' class="left_two_list" :class="{click_list:this.click_index == 2}">
      ...
      <div  v-if="show_map(19) == 19" @click='dd' class="left_two_list" :class="{click_list:this.click_index == 4}">
        <div class="list_right list_right_one">
          <p>电量池年度交易</p>
        </div>
      </div>
