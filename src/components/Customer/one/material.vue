      ...
      <div class="ma_content">
        ...
        <div v-if="this.no_val == 1" class="content_list">
          <div
            ...
            @click="list_daterial(item.id,item.signStatus)"
          ...
          <div class="add_div_two" slot="footer">
            <div class="cont_btn">
              <el-upload
                ...
                :data="this.url_data"
              >
                <el-button size="small" type="primary" :loading="this.load_add_0">导入数据</el-button>
              </el-upload>
            </div>
            <div class="wi_btn">
              <el-button size="small" @click="import_list_m">
          ...
          <div class="add_div_two" slot="footer">
            <div class="cont_btn">
              <el-upload
                ...
                multiple
              >
                <el-button size="small" type="primary" :loading="this.load_add_0">继续导入</el-button>
              </el-upload>
            </div>
            <div class="wi_btn">
      ...
      <el-dialog title="导入数据" :visible.sync="d_error">
        <div class="add_div">
          ...
          <div class="add_div_two" slot="footer">
            <div class="add_su_btn">
              <el-upload
                ...
                multiple
              >
                <el-button size="small" type="primary" :loading="this.load_add_0">重新导入</el-button>
              </el-upload>
          ...
          <div class="add_error_list">
            <p>导入失败信息：</p>
            <div v-for="(item,index) in this.d_failList">
...
export default {
  ...
  methods: {
    ...
    list_daterial(id, type) {
      //查看详情
      this.$router.push({
        name: "CustomerDetails",
        params: { one: id, two: type }
      });
    },
    find_list() {
      //进行筛选
