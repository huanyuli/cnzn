<template>
  <div>
    <div class="marterial">
      ...
      <div class="ma_content edit_user_input">
        ...
        <div  class="list_module">
          ...
          <div  class="list_con">
            <div class="list_tile list_margin_top">基础信息</div>
            ...
            <div class="list_con_input">
              ...
              <div class="list_con_input">
                <el-form-item label="所在区域" prop="one_3">
                  <el-select size="medium" @change="change_2" v-model="ruleForm.one_3" placeholder="请选择">
                    <el-option
            ...
            <div class="list_con_input">
              ...
              <!--</div>-->
              <!--<div class="list_con_input">-->
                <!--<el-form-item label="法人" prop="one_13">-->
          ...
          <div class="list_con" >
            ...
            <div class="list_con_input">
              <el-form-item label="统一社会信用代码" prop="add_two_1">
                <el-input size="medium" v-model="ruleForm.add_two_1" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
            ...
            <div class="list_con_input">
              <el-form-item label="法定代表人姓名" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_2" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="开户银行" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_3" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="开户名称" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_4" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="开户账号" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_5" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="税务登记号" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_6" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="组织机构代码" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_7" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="营业期限" prop="">
                <el-input size="medium" v-model="ruleForm.add_two_8" placeholder=""></el-input>
              </el-form-item>
            </div>
            ...
            <div class="list_con_input">
              <el-form-item label="负荷性质"  prop="two_1">
                <el-select size="medium" v-model="ruleForm.two_1"  multiple  collapse-tags clearable  placeholder="请选择">
                  <el-option
            ...
            <div class="list_con_input">
              <el-form-item label="营销目录价格"  prop="two_5">
                <el-input type="number"  size="medium" placeholder="" v-model.number="ruleForm.two_5">
            ...
            <div class="list_con_input">
              <el-form-item label="报装容量"  prop="two_6">
                <el-input type="number"  size="medium" placeholder="" v-model.number="ruleForm.two_6">
            ...
            <div class="list_con_input">
              <el-form-item label="签约电量"  prop="two_7">
                <el-input type="number"  size="medium" placeholder="" v-model.number="ruleForm.two_7">
                  <template slot="append">兆瓦时</template>
                </el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="交易类型"  prop="two_9">
                <el-select size="medium" v-model="ruleForm.two_9" multiple collapse-tags placeholder="请选择">
                  <el-option
            ...
            <div class="list_con_input">
              <el-form-item label="履约情况"  prop="two_8">
                <el-select size="medium" v-model="ruleForm.two_8" clearable placeholder="请选择">
                  <el-option
            ...
            <div class="list_con_input">
              <el-form-item label="用电户号"  prop="two_12">
                <el-input size="medium" v-model="ruleForm.two_12" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
            ...
            <div class="list_con_input">
              <el-form-item label="所属集团"  prop="two_10s">
                <el-input size="medium" v-model="ruleForm.two_10s" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="所属供电公司"  prop="two_11">
                <el-input size="medium" v-model="ruleForm.two_11" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="总用电容量"  prop="two_13">
                <el-input type="number"  size="medium" placeholder="" v-model.number="ruleForm.two_13">
            ...
            <div class="list_con_input">
              <el-form-item label="最大需量"  prop="">
                <el-input type="number"  size="medium" placeholder="" v-model.number="ruleForm.add_two_9">
            ...
            <div class="list_con_input">
              <el-form-item label="用电地址"  prop="">
                <el-input size="medium" v-model="ruleForm.add_two_10" placeholder=""></el-input>
              </el-form-item>
            </div>
            <div class="list_con_input">
              <el-form-item label="高耗能行业类别"  prop="">
                <el-select size="medium" v-model="ruleForm.add_two_11" clearable placeholder="请选择">
                  <el-option
            ...
            <div class="list_con_input">
              <el-form-item label="是否执行峰谷标志"  prop="">
                <el-select size="medium" v-model="ruleForm.add_two_12" clearable placeholder="请选择">
                  <el-option
            ...
            <div class="list_con_input">
              <el-form-item label="是否核定了输配"  prop="">
                <el-select size="medium" v-model="ruleForm.add_two_13" clearable placeholder="请选择">
                  <el-option
                    v-for="item in form_add_5"
                    :key="item.value"
                    :label="item.label"
            ...
            <div class="list_con_input">
              <el-form-item label="是否电能替代项目"  prop="">
                <el-select size="medium" v-model="ruleForm.add_two_14" clearable placeholder="请选择">
                  <el-option
                    v-for="item in form_add_5"
                    :key="item.value"
                    :label="item.label"
    ...
    data() {
      ...
      return {
        ...
        rules: {  //第一步的验证
          ...
          one_4:[
            { required: false, message: '请选择行政区域', trigger: 'change' },
          ],
          one_5:[
          ...
          two_4:[
            { required: false, message: '请选择用电类别', trigger: 'change' },
          ],
          two_11:[
      ...
      submitForm(formName) {  //表单提交验证
        this.$refs[formName].validate((valid) => {
          if (valid) {
            ...
            if(isNaN(this.ruleForm.add_1)){  //判断是否为id，如果不为ID，说明客户经理没有被改动
              this.ruleForm.add_1 = this.user_id
            }
            this.add_create ={
                  id:this.deta_id,
                ...
                registerAddress:this.ruleForm.one_12,
                representative:this.ruleForm.one_13,
              ...
              phone:this.ruleForm.one_14,
                ...
                useElectricity:this.ruleForm.two_2,
                voltageLevel:this.ruleForm.two_3,
                usePowerType:this.ruleForm.two_4,
                originalPowerPrice:this.ruleForm.two_5,
                applyCapacity:this.ruleForm.two_6,
                signingElectricity:this.ruleForm.two_7,
                performanceSituation:this.ruleForm.two_8,
                transactionType: this.arr_find(this.ruleForm.two_9),
                useElectricityCompany:this.ruleForm.two_10,
                ownerGroup:this.ruleForm.two_10s,
                powerCompany:this.ruleForm.two_11,
                usePowerNumber:this.ruleForm.two_12,
                totalUsePowerAmount:this.ruleForm.two_13,
...
//                contactOfficePhoneNo:this.ruleForm.add_11,
              ...
              customerCode:this.ruleForm.add_14,
                ...
                openBank:this.ruleForm.add_two_3,
                openAcctName:this.ruleForm.add_two_4,
                openAcctNo:this.ruleForm.add_two_5,
                taxNumber:this.ruleForm.add_two_6,
                orgNo:this.ruleForm.add_two_7,
                businessTerm:this.ruleForm.add_two_8,
                maxNeedElectric:this.ruleForm.add_two_9,
                powerAddress:this.ruleForm.add_two_10,
                highEnergyCIndustry:this.ruleForm.add_two_11,
                valleyFlag:this.ruleForm.add_two_12,
                checkTransFlag:this.ruleForm.add_two_13,
                substitutionFlag:this.ruleForm.add_two_14,
                transformerList:this.lists,  //客户变压器容量列表

              }
              this.add_create = JSON.stringify(this.add_create);
              add_ajax.customerEditService(this.add_create, res => {  //创建
                this.$emit('login-success', res);
              }, (res) => {
                if(res.status == 200){
...
//生命周期钩子函数，进入页面显示之前获取数据到store
    created() {
      this.deta_id = this.$route.params.one
...
//          form_one_3:[], //所在区域
      ...
      this.form_deta = "{'id': "+ this.deta_id +"}";
      add_ajax.customerDetailService(this.form_deta, res => {  //客户详情
        this.$emit('login-success', res);
      }, (res) => {
        this.form_list = res.body

        if(this.form_list.name != null){
          this.ruleForm.one_1 = this.form_list.name
        }
        if(this.form_list.industry != null && this.form_list.industry != ""){
          this.ruleForm.one_2 = this.zh_val(this.form_one_2,this.form_list.industry)
        }
        if(this.form_list.provinceCode != null){
          this.ruleForm.one_3 = this.form_list.provinceCode
          //获取市下拉列表
          this.form_code_q ={
            code:this.ruleForm.one_3,
            areaLevel:"province"
          ...
          this.form_code_q = JSON.stringify(this.form_code_q);
          add_ajax.areaListService(this.form_code_q, res => {  //市
            this.$emit('login-success', res);
          }, (res) => {
            this.form_select_q = res.body;
            var _temp_one_4 = this.form_one_4;
            $.map(this.form_select_q,function(value){
              _temp_one_4.push({
                value:value.code,
                label:value.name
            ...
            if(this.form_list.cityCode != null){
              this.ruleForm.one_4 = this.form_list.cityCode
              this.form_code_qs ={
                code:this.ruleForm.one_4,
                areaLevel:"city"
              }
              ...
              add_ajax.areaListService(this.form_code_qs, res => {  //列表字典
                ...
                if(this.form_list.countyCode != null){
                  this.ruleForm.add_one_4 = this.form_list.countyCode
                }
                if(this.form_list.county != null){
                  this.ruleForm.add_one_4_s= this.form_list.county
                }

              });
            }
            if(this.form_list.city != null){
              this.ruleForm.one_4s = this.form_list.city
            }
          });
        }

        if(this.form_list.province != null){
          this.ruleForm.one_3s = this.form_list.province
        }

        if(this.form_list.powerAreaNature != null && this.form_list.powerAreaNature != ""){
          this.ruleForm.one_5 = this.zh_val(this.form_one_5,this.form_list.powerAreaNature)
        }

        if(this.form_list.provincePowerGrid != null){
         // this.ruleForm.one_6 = this.zh_val(this.form_one_6,this.form_list.provincePowerGrid)
          this.ruleForm.one_6 = this.form_list.provincePowerGrid
        }
        if(this.form_list.customerType != null && this.form_list.customerType != ""){
          this.ruleForm.one_7 = this.zh_val(this.form_one_7,this.form_list.customerType)
        }
        if(this.form_list.mainPower != null){
          this.ruleForm.one_8 = this.form_list.mainPower
        }
        if(this.form_list.powerStationAssetOwner != null && this.form_list.powerStationAssetOwner != ""){
          this.ruleForm.one_9 = this.zh_val(this.form_one_9,this.form_list.powerStationAssetOwner)
        }
        if(this.form_list.companyScale != null && this.form_list.companyScale != ""){
          this.ruleForm.one_10 = this.zh_val(this.form_one_10,this.form_list.companyScale)
        }
        if(this.form_list.companyNature != null && this.form_list.companyNature != ""){
          this.ruleForm.one_11 = this.zh_val(this.form_one_11,this.form_list.companyNature)
        }
        if(this.form_list.registerAddress != null){
          this.ruleForm.one_12 = this.form_list.registerAddress
        }
        if(this.form_list.representative != null){
          this.ruleForm.one_13 = this.form_list.representative
        }
        if(this.form_list.contact != null){
          this.ruleForm.one_15 = this.form_list.contact
        }
        if(this.form_list.phone != null && this.form_list.phone != ""){
          this.ruleForm.one_14 = parseFloat(this.form_list.phone)
        }
        if(this.form_list.email != null){
          this.ruleForm.one_16 = this.form_list.email
        }

        if(this.form_list.loadNature != null && this.form_list.loadNature != ""){
          this.ruleForm.two_1 = this.zh_val_s(this.form_two_1,this.form_list.loadNature)
        }
        if(this.form_list.useElectricity != null){
          this.ruleForm.two_2 = this.form_list.useElectricity
        }
        if(this.form_list.voltageLevel != null && this.form_list.voltageLevel != ""){
          this.ruleForm.two_3 = this.zh_val(this.form_two_3,this.form_list.voltageLevel)
        }
        if(this.form_list.usePowerType != null && this.form_list.usePowerType != ""){
          this.ruleForm.two_4 = this.zh_val(this.form_two_4,this.form_list.usePowerType)
        }
        if(this.form_list.originalPowerPrice != null){
          this.ruleForm.two_5 = this.form_list.originalPowerPrice
        }
        if(this.form_list.applyCapacity != null){
          this.ruleForm.two_6 = this.form_list.applyCapacity
        }
        if(this.form_list.signingElectricity != null){
          this.ruleForm.two_7 = this.form_list.signingElectricity
        }
        if(this.form_list.performanceSituation != null){
          this.ruleForm.two_8 = this.form_list.performanceSituation
         // this.ruleForm.two_8 = this.zh_val(this.form_two_8,this.form_list.performanceSituation)
        }
        if(this.form_list.transactionType != null && this.form_list.transactionType != ""){
          this.ruleForm.two_9 = this.zh_val_s(this.form_two_9,this.form_list.transactionType)
        }
        if(this.form_list.useElectricityCompany != null){
          this.ruleForm.two_10 = this.form_list.useElectricityCompany
        }
        if(this.form_list.ownerGroup != null){
          this.ruleForm.two_10s = this.form_list.ownerGroup
        }
        if(this.form_list.powerCompany != null){
          this.ruleForm.two_11 = this.form_list.powerCompany
        }
       if(this.form_list.usePowerNumber != null){
         this.ruleForm.two_12 = this.form_list.usePowerNumber
       }
       if(this.form_list.totalUsePowerAmount != null){
         this.ruleForm.two_13 = this.form_list.totalUsePowerAmount
       }

        if(this.form_list.businessName != null){
          this.ruleForm.add_1 = this.form_list.businessName
        }

        if(this.form_list.businessId != null){
          this.user_id = this.form_list.businessId
        }

        if(this.form_list.otherName != null){
          this.ruleForm.add_2 = this.form_list.otherName
        }

        if(this.form_list.companySimpleName != null){
          this.ruleForm.add_3 = this.form_list.companySimpleName
        }

        if(this.form_list.powerUnit != null){
          this.ruleForm.add_4 = this.form_list.powerUnit
        }
        if(this.form_list.priceStrategy != null && this.form_list.priceStrategy != ""){
          this.ruleForm.add_5 =  this.zh_val(this.form_add_2,this.form_list.priceStrategy)
        }
        if(this.form_list.electricType != null && this.form_list.electricType != ""){
          this.ruleForm.add_6 = this.zh_val(this.form_add_3,this.form_list.electricType)
        }

        if(this.form_list.saleSettlementCompany != null){
          this.ruleForm.add_7 = this.form_list.saleSettlementCompany
        }
        if(this.form_list.contactDuty != null){
          this.ruleForm.add_8 = this.form_list.contactDuty
        }
        if(this.form_list.contactAddress != null){
          this.ruleForm.add_9 = this.form_list.contactAddress
        }
        if(this.form_list.contactZipCode != null){
          this.ruleForm.add_10 = this.form_list.contactZipCode
        }
        if(this.form_list.contactNumber != null  && this.form_list.contactNumber != ""){
          this.ruleForm.add_11 = this.form_list.contactNumber
        }
        if(this.form_list.contactFax != null && this.form_list.contactFax != ""){
          this.ruleForm.add_12 = this.form_list.contactFax
        }
        ...
        if(this.form_list.representativeName != null && this.form_list.representativeName != ""){
          this.ruleForm.add_two_2 = this.form_list.representativeName
        }
        if(this.form_list.openBank != null && this.form_list.openBank != ""){
          this.ruleForm.add_two_3 = this.form_list.openBank
        }
        if(this.form_list.openAcctName != null && this.form_list.openAcctName != ""){
          this.ruleForm.add_two_4 = this.form_list.openAcctName
        }
        if(this.form_list.openAcctNo != null && this.form_list.openAcctNo != ""){
          this.ruleForm.add_two_5 = this.form_list.openAcctNo
        }
        if(this.form_list.taxNumber != null && this.form_list.taxNumber != ""){
          this.ruleForm.add_two_6 = this.form_list.taxNumber
        }
        if(this.form_list.orgNo != null && this.form_list.orgNo != ""){
          this.ruleForm.add_two_7 = this.form_list.orgNo
        }
        if(this.form_list.businessTerm != null && this.form_list.businessTerm != ""){
          this.ruleForm.add_two_8 = this.form_list.businessTerm
        }
        if(this.form_list.maxNeedElectric != null  && this.form_list.maxNeedElectric != ""){
          this.ruleForm.add_two_9 = this.form_list.maxNeedElectric
        }
        if(this.form_list.powerAddress != null && this.form_list.powerAddress != ""){
          this.ruleForm.add_two_10 = this.form_list.powerAddress
        }
        if(this.form_list.highEnergyCIndustry != null && this.form_list.highEnergyCIndustry != ""){
          this.ruleForm.add_two_11 = this.zh_val(this.form_add_4,this.form_list.highEnergyCIndustry)
        }

        if(this.form_list.valleyFlag != null && this.form_list.valleyFlag != ""){
          this.ruleForm.add_two_12 = this.zh_val(this.form_add_5,this.form_list.valleyFlag)
        }
        if(this.form_list.checkTransFlag != null && this.form_list.checkTransFlag != ""){
          this.ruleForm.add_two_13 = this.zh_val(this.form_add_5,this.form_list.checkTransFlag)
        }
        if(this.form_list.substitutionFlag != null && this.form_list.substitutionFlag != ""){
          this.ruleForm.add_two_14 = this.zh_val(this.form_add_5,this.form_list.substitutionFlag)
        }

        if(this.form_list.transformerList.length != 0 && this.form_list.transformerList != null){
          this.lists = this.form_list.transformerList
        }
      });
...
<style>
  /*.edit_user_input .list_module .el-input__inner{*/
    /*padding: 0 15px!important;*/
    /*margin-top: 0px!important;*/
  /*}*/
  /*.edit_user_input .el-input--prefix .el-input__inner {*/
    /*padding-left: 30px!important;*/
  /*}*/
  /*.edit_user_input .el-input--suffix .el-input__inner {*/
