...
userDeleteService(params, success_callback, fail_callback) {
  withAxios.requestData('POST', 3,'/api/userDeleteService', params, success_callback, fail_callback);
},
  ...
  userCreateService(params, success_callback, fail_callback) {
    withAxios.requestData('POST', 3,'/api/userCreateService', params, success_callback, fail_callback);
  },
  ...
  userEditService(params, success_callback, fail_callback) {
    withAxios.requestData('POST', 3,'/api/userEditService', params, success_callback, fail_callback);
  },
  ...
  roleListService(params, success_callback, fail_callback) {
    withAxios.requestData('POST', 3,'/api/roleListService', params, success_callback, fail_callback);
  },
  ...
  menuListService(params, success_callback, fail_callback) {
    withAxios.requestData('POST', 3,'/api/menuListService', params, success_callback, fail_callback);
  },
  ...
  roleCreateService(params, success_callback, fail_callback) {
    withAxios.requestData('POST', 3,'/api/roleCreateService', params, success_callback, fail_callback);
  },
  /**
   * /api/roleEditService 编辑角色
   */
  roleEditService(params, success_callback, fail_callback) {
    withAxios.requestData('POST', 3,'/api/roleEditService', params, success_callback, fail_callback);
  },
